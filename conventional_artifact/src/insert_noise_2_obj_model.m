function [fbp] = insert_noise_2_obj_model(obj, obj_info, sys_info, misc_info)
...
%%
    ...
    % all the exps before 6/10/2024 with mu_water 0.21 (@ 60 KeV)
    % some of the other typical attenuation coefficient of 
    % water include 0.167 @ 100 KeV, 0.19 @ 70 KeV
