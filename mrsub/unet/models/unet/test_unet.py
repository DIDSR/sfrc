...
SB: Modified train_unet.py to perform reconstructions from retrospectively 
undersampled full k-space data.
"""
...
class UnetMRIModel(MRIModel):
    ...
    def test_data_transform(self):
        #center_fractions_test = [0.16] # 2x
        #accelerations_test = [2]
        center_fractions_test = [0.12] # 3x
        accelerations_test = [3]
        # center_fractions_test = [0.08] # 4x
        # accelerations_test = [4]
        # center_fractions_test = [0.07] # 5x
        # accelerations_test = [5]
        # center_fractions_test = [0.06] # 6x
        # accelerations_test = [6]
        # center_fractions_test = [0.04] # 8x
        # accelerations_test = [8]
        mask_type_test = 'equispaced'
        #mask_type_test = 'random'
        mask = create_mask_for_mask_type(mask_type_test, center_fractions_test,
                                         accelerations_test)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-dir', type=pathlib.Path, default='reconstructions', help='Path where recons should be saved') # SB
