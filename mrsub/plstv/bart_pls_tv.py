...
import os,sys
import numpy as np
# path = os.environ["BART_TOOLBOX_PATH"] + "/python/"
# path to bart's python wrapper from https://github.com/mrirecon/bart
path = '/home/prabhat.kc/Implementations/learn/bart/python' 
...
img_mask = np.load('../recon_data/seg_mask_ood/sm_'+str(idx)+'.npy')
mk_recon = recon*img_mask
#np.save(recon_dir+'recon_'+str(idx)+'.npy',recon)
recon_im = Image.fromarray(convert_to_uint(mk_recon))
